...
class TicketController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $lastTicket = $entityManager->getRepository(Ticket::class)->findOneBy([], ['ticket_id' => 'DESC']);
    ...
    #[IsGranted('ROLE_USER')]
    public function edit(Request $request, Ticket $ticket, EntityManagerInterface $entityManager, MailNotificationService $mailService): Response
    {
        $user = $this->getUser();
        $activeRole = $request->getSession()->get('active_role');
